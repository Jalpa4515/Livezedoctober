            ...
            <div class="tp-accountForm form-style">
              ...
              <div class="row">
                ...
                <?php
                  ...
                  ?>
                  <div class="col-lg-12 col-md-12 col-12">
                    <input type="number" style="height: 44px !important; margin-bottom:5px !important;" oninput="myFunction()" id="amount" name="amount" placeholder="Enter Qty">
                    <div>Total Estimated Price: <span id="demo"></span></div>
                  </div>
                  <!-- product_qty -->
                  <script>
                    function myFunction() {
