...
if ($success === true) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394052658821\",\"sms\":[{\"message\":\You have got one donation on ZedAid campaign $shortTitle.\",\"to\":[\"$meta_valuephone\"]}]}",
    ...
    curl_setopt_array($curl2, array(
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => "POST",
        CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394059407777\",\"sms\":[{\"message\":\"ZedAid got one donation on Campaign $shortTitle.\",\"to\":[\"$phone2\"]}]}",
        CURLOPT_HTTPHEADER => array(
            "authkey: 328268AQTjWikZLti61725bd1P1",
            "cache-control: no-cache",
            "content-type: application/json",
