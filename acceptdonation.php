...
$shortUserName = substr($user_name,0,30);
$shortDisName = substr($display_name,0,30);
$smsMsg = "Dear $shortDisName, Your donation request on $shortTitle has been approved by campaigner $shortUserName on ZedAid.";
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"unicode\":\"1\",\"DLT_TE_ID\":\"1307163491098737300\",\"sms\":[{\"message\":\"$smsMsg\",\"to\":[\"$phone\"]}]}",
