...
$smstext = 'Dear '.$shortDisName.', your campaign '.$shortTitle.' is created successfully. ZedAid will review it and approve soon within 24 hours.';

if(substr($phoneu,0,3) == "+91") {
    $phoneu = substr($phoneu,3,$phoneu.length);    
}
...
curl_setopt_array($curl2, array(
    ...
    CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307162620976143979\",\"sms\":[{\"message\":\"$smstext\",\"to\":[\"$phoneu\"]}]}",
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
    CURLOPT_CUSTOMREQUEST => "POST",
    CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394000623430\",\"sms\":[{\"message\":\"$smstextAdmin\",\"to\":[\"9892489040\"]}]}",
    CURLOPT_HTTPHEADER => array(
        "authkey: 328268AQTjWikZLti61725bd1P1",
        "cache-control: no-cache",
        "content-type: application/json",
